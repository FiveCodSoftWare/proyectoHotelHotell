   ...
   this.setLocationRelativeTo(null);
    ...
    private void tablaRegistroTipoHabitacionesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaRegistroTipoHabitacionesMousePressed
        if (evt.getClickCount() == 2) {
            ...
            jDialogRestroHabitaciones.txtIdTidpoHabitacion.setText(cod);
            jDialogRestroHabitaciones.cbotipo_habitacion.addItem(valor1);
            jDialogRestroHabitaciones.txtPrecio.setText(valor2);
            jDialogRestroHabitaciones.txtDescripcion.setText(valor3);
