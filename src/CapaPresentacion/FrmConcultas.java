...
//        }
    ...
    private void initComponents() {
        ...
        btnPrecioPromedio.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(btnPrecioPromedio, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        panel1Layout.setVerticalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                ...
                .addComponent(btnPrecioPromedio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(48, 48, 48))
        );
    ...
    private void btnMenoresAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenoresAActionPerformed
        ...
        txtInicio.setText("");
         int cantidad;
       cantidad = Integer.parseInt(txtMenorA.getText());
        modelo = consulta.mostrarProductosMenoresA(cantidad);
        this.tblPrincipal.setModel(modelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Error al calcular: "+e.getMessage());
        }
